...
*/
	//Posunu se o jedna (pripadne se vzatim na zacatek)
...
*/
	//Zactek a konec fronty jsou na stejnem indexu
...
*/
	//Za koncem fronty uz neni zadne volne misto (dalsi prvek za koncem je zacatek fronty)
...
*/
	if(queueEmpty(q))
		...
		//Vyber prvku z pole arr na indexu zacatku
		*c = q->arr[q->f_index];
}
...
*/
	...
	{
		//Na prvni volne misto dam hodnotu c
		q->arr[q->b_index] = c;
		//Posunu se na dalsi volne misto
